...
(function () {
  ...
  /* Contexte WebGL créé à l'approche seulement (voir acte3d.js). */
  var differer = (window.ODN && window.ODN.differer) ||
    function (x, lancer) { lancer(); };
  var fondre = (window.ODN && window.ODN.fondre) ||
